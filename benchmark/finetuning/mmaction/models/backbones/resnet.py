...
class ResNet(nn.Module):
    ...
    arch_settings = {
        'convnext_tiny': (BasicBlock, (2, 2, 2, 2)),
        'convnext_small': (BasicBlock, (3, 4, 6, 3)),
        'convnext_base': (Bottleneck, (3, 4, 6, 3)),
        'convnext_large': (Bottleneck, (3, 4, 23, 3)),
        'convnext_xlarge': (Bottleneck, (3, 8, 36, 3))
    }
