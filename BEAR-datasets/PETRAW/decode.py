...
data_root = './Test/Video/'
annotations_root = './Test/Procedural_description/'
frame_root = './Test/frames/'
if not os.path.exists(frame_root):
    os.mkdir(frame_root)

test_anno_file_csv = open('petraw_test.csv', 'w')
...
for video_name in video_list_dir:
    ...
    annotations_path = os.path.join(annotations_root, video_id + '.txt')
